...
class MyEventState extends BasePageState<MyEventModel> {
  MyEventState();
  ...
  MyEventState.build(this.model, void Function(MyEventModel m) f)
      : super.build(model!, f);
  ...
  @override
  MyEventState fromStore() => MyEventState.build(
          read<MyEventModel>(
            MyEventModel(
