...
class OffertoryView extends BaseStatefulPageView {
  ...
  OffertoryView(this.model, {Key? key})
      : _infos = List.generate(
            model?.offertories?.length ?? 0, (index) => model?.offertories![index] as Map),
        super();
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                ...
                                ? widget.model!.items![currentParishId]['completename']
                                : '---',
                        ...
                        children:[
                          Expanded(
                            child: RawMaterialButton(
                              ...
                              materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                              onPressed: () async {
                                await widget.model!.navigateTo!(currentParishId + 1, '/_/church_info');
                              },
                              child: const Align(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          RawMaterialButton(
                            ...
                            materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
                            onPressed: () {
                              final orgWebsite = widget._infos[0]['url'] ?? '';
                    ...
                    children: [
                      ...
                      Column(
                        children: widget._infos.map<Widget>((element) {
                          if (widget._infos[0]['name'] == element['name']) {
                            return Container();
                          }
